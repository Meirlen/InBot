...
#         self.add_data_to_txt(f'User:         {text}',f'/Users/meirlen/Desktop/bot/dataset/test/{file_path}')
...
#                 self.add_data_to_txt(delimetr,f'/Users/meirlen/Desktop/bot/dataset/test/{file_path}')
#             else:
#                 self.add_data_to_txt(f'CallBot:      {message_part} ',f'/Users/meirlen/Desktop/bot/dataset/test/{file_path}')
