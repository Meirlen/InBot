...
#                  switch_inline_query_current_chat=None, callback_game=None, pay=None, login_url=None,web_app=None, **kwargs):
#         self.text: str = text
#         self.url: str = url
...
# class WebAppInfo(Dictionaryable, JsonSerializable, JsonDeserializable):
#     @classmethod
#     def de_json(cls, json_string):
#         if json_string is None: return None
#         obj = cls.check_json(json_string, dict_copy=False)
